...
import mySound from "../../assets/sendres.wav"
...
function UserInfo() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:3001/teacher/' + userid)
  ...
  absentEmpData.map((emp) => {
    ...
    if (emp.emp.id == userid) {
      setAbsentEmpData(absentEmpData.filter(emp => emp.emp.id !== userid))
      counterAbsent++
  ...
  MessgesData.map((emp) => {
    ...
    if (emp.emp.id == userid) {
      setMessgesData(MessgesData.filter(emp => emp.emp.id !== userid))
                    ...
                    <>
                      ...
                      <Panel header={"الرسالة : "} toggleable collapsed style={{ marginTop: "2rem" }}>
                        <p className="m-0">
                          <Editor
                            readOnly={true}
                            style={{ height: '140px', textAlign: "start", marginBottom: "2rem" }}
                            value={mes.massage}
                            rows={5}
                            cols={5}
                          />
                          {mes.res ===
                                ...
                                onClick={
                                  ...
                                  () => {
                                    ...
                                    fetch("http://localhost:3001/messages/" + mes.id, {
                                      ...
                                      body: JSON.stringify({
                                        emp: { name: teachers.name, id: userid },
                                        massage: mes.massage,
                                        res: mes.res
                                      })
                                    ...
                                    playSound()
                                    setTimeout(() => {
                                      location.assign("/userinfo/" + userid)
                                    }, 1300)
                            ...
                            <Editor
                              readOnly={true}
                              style={{ height: '100px', textAlign: "start", backgroundColor: "#697a8d1f" }}
                              value={mes.res}
                              rows={5}
                              cols={5}
                            />
