...
var useClickOutside = function useClickOutside2(ref, callback) {
  ...
  }), _useEventListener2 = _slicedToArray2(_useEventListener, 2), bindMouseDownListener = _useEventListener2[0], unbindMouseDownListener = _useEventListener2[1];
  var _useEventListener3 = useEventListener({
    type: "touchstart",
    listener: isOutsideClicked
  }), _useEventListener4 = _slicedToArray2(_useEventListener3, 2), bindTouchStartListener = _useEventListener4[0], unbindTouchStartListener = _useEventListener4[1];
  React3.useEffect(function() {
    if (!ref.current) {
      return;
    }
...
var useCounter = function useCounter2() {
  ...
  var _React$useState = React3.useState(initialValue), _React$useState2 = _slicedToArray2(_React$useState, 2), count = _React$useState2[0], setCount = _React$useState2[1];
...
var useIntersectionObserver = function useIntersectionObserver2(ref) {
  var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var _React$useState = React3.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), isElementVisible = _React$useState2[0], setIsElementVisible = _React$useState2[1];
  React3.useEffect(function() {
    if (!ref.current) {
      return;
    }
...
var useMouse = function useMouse2() {
  var _React$useState = React3.useState({
    x: 0,
    y: 0
  }), _React$useState2 = _slicedToArray2(_React$useState, 2), position = _React$useState2[0], setPosition = _React$useState2[1];
  var ref = React3.useRef(null);
  var handleMouseMove = React3.useCallback(function(event) {
    var x;
    var y;
    if (ref.current) {
  ...
  }), _useEventListener2 = _slicedToArray2(_useEventListener, 2), bindMouseMoveEventListener = _useEventListener2[0], unbindMouseMoveEventListener = _useEventListener2[1];
  var _useEventListener3 = useEventListener({
    type: "mousemove",
    listener: handleMouseMove
  }), _useEventListener4 = _slicedToArray2(_useEventListener3, 2), bindDocumentMoveEventListener = _useEventListener4[0], unbindDocumentMoveEventListener = _useEventListener4[1];
  var reset = function reset2() {
    return setPosition({
      x: 0,
      y: 0
...
function useMove(_ref) {
  ...
  var _React$useState = React3.useState(initialValue), _React$useState2 = _slicedToArray2(_React$useState, 2), positions = _React$useState2[0], setPositions = _React$useState2[1];
  var _React$useState3 = React3.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), active = _React$useState4[0], setActive = _React$useState4[1];
  var isMounted = React3.useRef(false);
  var isSliding = React3.useRef(false);
  var ref = React3.useRef(null);
  ...
  }), _useEventListener10 = _slicedToArray2(_useEventListener9, 2), bindMouseDownListener = _useEventListener10[0], unbindMouseDownListener = _useEventListener10[1];
  ...
  }), _useEventListener12 = _slicedToArray2(_useEventListener11, 2), bindTouchStartListener = _useEventListener12[0], unbindTouchStartListener = _useEventListener12[1];
  ...
  var _useEventListener = useEventListener({
    ...
    listener: function listener(event) {
      ...
      if (event.storageArea === area && event.key === key) {
        var newValue = event.newValue ? JSON.parse(event.newValue) : void 0;
        setStoredValue(newValue);
      }
    }
  }), _useEventListener2 = _slicedToArray2(_useEventListener, 2), bindWindowStorageListener = _useEventListener2[0], unbindWindowStorageListener = _useEventListener2[1];
  var _React$useState = React3.useState(initialValue), _React$useState2 = _slicedToArray2(_React$useState, 2), storedValue = _React$useState2[0], setStoredValue = _React$useState2[1];
...
//# sourceMappingURL=chunk-Y2JICITL.js.map
