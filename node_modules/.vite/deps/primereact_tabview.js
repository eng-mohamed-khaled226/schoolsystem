...
var TabView = React.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React.useState(true), _React$useState4 = _slicedToArray(_React$useState3, 2), backwardIsDisabledState = _React$useState4[0], setBackwardIsDisabledState = _React$useState4[1];
  var _React$useState5 = React.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), forwardIsDisabledState = _React$useState6[0], setForwardIsDisabledState = _React$useState6[1];
  var _React$useState7 = React.useState([]), _React$useState8 = _slicedToArray(_React$useState7, 2), hiddenTabsState = _React$useState8[0], setHiddenTabsState = _React$useState8[1];
  var _React$useState9 = React.useState(props.activeIndex), _React$useState10 = _slicedToArray(_React$useState9, 2), activeIndexState = _React$useState10[0], setActiveIndexState = _React$useState10[1];
  ...
  var createTabHeader = function createTabHeader2(tab, index) {
    ...
    var titleElement = React.createElement("span", headerTitleProps, header3);
    ...
    var icon = closeIcon || React.createElement(TimesIcon, closeIconProps);
    ...
    var content4 = (
      // eslint-disable /
      React.createElement("a", headerActionProps, leftIconElement, titleElement, rightIconElement, closableIconElement, React.createElement(Ripple, null))
    );
    if (headerTemplate) {
    ...
    return React.createElement("li", headerProps, content4);
  };
  ...
  var createNavigator = function createNavigator2() {
    ...
    return React.createElement("div", navContentProps, React.createElement("ul", navProps, headers, React.createElement("li", inkbarProps)));
  };
  var createContent = function createContent2() {
    ...
    var contents = React.Children.map(props.children, function(tab, index) {
      if (shouldUseTab(tab) && (!props.renderActiveOnly || isSelected(index))) {
        ...
        return React.createElement("div", contentProps, !props.renderActiveOnly ? getTabProp(tab, "children") : selected && getTabProp(tab, "children"));
      }
    });
    return React.createElement("div", panelContainerProps, contents);
  };
  var createPrevButton = function createPrevButton2() {
    var prevIconProps = mergeProps({
      "aria-hidden": "true"
    }, ptm("previcon"));
    var icon = props.prevButton || React.createElement(ChevronLeftIcon, prevIconProps);
    ...
    if (props.scrollable && !backwardIsDisabledState) {
      return React.createElement("button", prevButtonProps, leftIcon, React.createElement(Ripple, null));
    }
    return null;
  };
  var createNextButton = function createNextButton2() {
    ...
    var icon = props.nextButton || React.createElement(ChevronRightIcon, nextIconProps);
    ...
    if (props.scrollable && !forwardIsDisabledState) {
      return React.createElement("button", nextButtonProps, rightIcon, React.createElement(Ripple, null));
    }
  };
  ...
  return React.createElement("div", rootProps, React.createElement("div", navContainerProps, prevButton, navigator, nextButton), content3);
});
