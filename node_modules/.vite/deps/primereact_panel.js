...
var Panel = React.forwardRef(function(inProps, ref) {
  ...
  var createToggleIcon = function createToggleIcon2() {
    if (props.toggleable) {
      ...
      return React.createElement("button", togglerProps, toggleIcon, React.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    ...
    var titleElement = React.createElement("span", titleProps, header2);
    var iconsProps = mergeProps({
      className: cx("icons")
    }, ptm("icons"));
    var iconsElement = React.createElement("div", iconsProps, icons, togglerElement);
    var headerProps = mergeProps({
      className: cx("header")
    }, ptm("header"));
    var content2 = React.createElement("div", headerProps, titleElement, iconsElement);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React.createElement("div", footerProps, footer2);
  ...
  var createContent = function createContent2() {
    ...
    return React.createElement(CSSTransition, _extends({
      nodeRef: contentRef
    }, transitionProps), React.createElement("div", toggleableContentProps, React.createElement("div", contentProps, props.children)));
  };
  ...
  return React.createElement("div", rootProps, header, content, footer);
});
